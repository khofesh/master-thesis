...
def makeModelName(mongoid, algo='svr', impute=True, multivariate=False, lag=1):
    '''
    Name a model.
...
def makeModel(mongoid, impute=True, inverse=False, save=False, lag=1):
    ...
    svrname = makeModelName(mongoid, algo='svr', impute=impute, multivariate=False, lag=lag)
