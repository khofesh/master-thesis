...
def makeModel(mongoid, impute=True, inverse=False, save=False, lag=1):
    ...
    if mongoid == listOfIds[0]:
        ...
        flatname = makeModelName(mongoid, algo='nn', impute=impute, multivariate=False,
        ...
        lstmname = makeModelName(mongoid, algo='nn', impute=impute, multivariate=False,
        ...
        gruname = makeModelName(mongoid, algo='nn', impute=impute, multivariate=False,
...
# Univariate-Imputed
#for i in listOfIds:
#    makeModel(i, impute=True, inverse=True, save=True, lag=2)

# Univariate-Not Imputed
for i in listOfIds:
    makeModel(i, impute=False, inverse=True, save=True, lag=2)
