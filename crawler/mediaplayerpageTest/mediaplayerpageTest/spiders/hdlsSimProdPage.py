...
class ProductPageSpider(scrapy.Spider):
    name = 'headlesssimpleproductpage'
    ...
    def parse(self, response):
        ...
        # number of questions
        questionsCnt = len(selDiscuss.xpath('//div[@class="list-box-replycomment talk-content first-talk"]'))
        # number of answers
        answersCnt = len(selDiscuss.xpath('//div[@class="list-box-replyholder"]'))
        ...
        if questionsCnt == 0:
            ...
            while True:
                try:
                    ...
                    questionsCnt += len(selDiscuss2.xpath('//div[@class="list-box-replycomment talk-content first-talk"]'))
                    # add number of answers
                    answersCnt += len(selDiscuss2.xpath('//div[@class="list-box-replyholder"]'))
